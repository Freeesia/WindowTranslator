...
namespace WindowTranslator.Plugin.GitHubCopilotPlugin.Properties;
...
internal class Resources
{
    ...
    public static global::System.Resources.ResourceManager ResourceManager
        => resourceMan ??= new CustomResourceManager("WindowTranslator.Plugin.GitHubCopilotPlugin.Properties.Resources", Assembly.GetExecutingAssembly());
    ...
    /// <summary>
    /// "GitHub Copilot設定" に類似しているローカライズされた文字列を検索します。
    /// </summary>
    public static string GitHubCopilotOptions => ResourceManager.GetString("GitHubCopilotOptions", resourceCulture) ?? string.Empty;

    /// <summary>
    /// "GitHub Copilot翻訳" に類似しているローカライズされた文字列を検索します。
    /// </summary>
    public static string GitHubCopilotTranslator => ResourceManager.GetString("GitHubCopilotTranslator", resourceCulture) ?? string.Empty;
    ...
    /// <summary>
    /// "翻訳モジュールに「GitHub Copilot翻訳」..." に類似しているローカライズされた文字列を検索します。
    /// </summary>
    ...
    /// <summary>
    /// "GitHub Copilotで利用可能なモデルのID..." に類似しているローカライズされた文字列を検索します。
    /// </summary>

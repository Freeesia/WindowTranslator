...
OrcaRouterのOpenAI互換APIを利用するAI翻訳モジュールです。OrcaRouterプラグインはアプリ本体に同梱されないため、プラグインストアからインストールしてください。

### メリット
- **無料で利用可能**: 無料モデルを選択すれば、無料で簡単にAI翻訳を使えます
- **豊富なモデル**: クレジットを利用すれば、OrcaRouter経由でさまざまなAIモデルを利用できます
- **APIキー入力不要**: ブラウザー認証で利用を開始できます

### デメリット
- **無料モデルの速度**: 無料モデルは有料モデルより翻訳速度が遅い場合があります
- **外部サービスへの送信**: 翻訳テキストはOrcaRouterと、選択した上流モデルの提供元へ送信されます

### 推奨される利用シーン
- 無料でAI翻訳を使いたい場合
- 1つのプラグインからさまざまなAIモデルを利用したい場合
